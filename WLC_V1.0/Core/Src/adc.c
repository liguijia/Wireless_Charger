...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = ADC_FSBB_VIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_FSBB_VIN_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_FSBB_IIN_Pin|ADC_FSBB_IOUT_Pin|ADC_FSBB_VOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PA7     ------> ADC2_IN4
    */
    GPIO_InitStruct.Pin = ADC_COIL_SNS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_COIL_SNS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(ADC_FSBB_VIN_GPIO_Port, ADC_FSBB_VIN_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_FSBB_IIN_Pin|ADC_FSBB_IOUT_Pin|ADC_FSBB_VOUT_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(ADC_COIL_SNS_GPIO_Port, ADC_COIL_SNS_Pin);
