...
void MX_HRTIM1_Init(void)
{
  ...
  if (HAL_HRTIM_ADCPostScalerConfig(&hhrtim1, HRTIM_ADCTRIGGER_3, 10-1) != HAL_OK)
  {
    Error_Handler();
  }
  pTimeBaseCfg.Period = PERIOD_MASTERTIMER;
  ...
  pTimerCfg.ResetTrigger = HRTIM_TIMRESETTRIGGER_OTHER3_CMP2;
  pTimerCfg.ReSyncUpdate = HRTIM_TIMERESYNC_UPDATE_UNCONDITIONAL;
  ...
  pDeadTimeCfg.RisingValue = DeathTime_FSBB;
  pDeadTimeCfg.RisingSign = HRTIM_TIMDEADTIME_RISINGSIGN_POSITIVE;
  pDeadTimeCfg.RisingLock = HRTIM_TIMDEADTIME_RISINGLOCK_WRITE;
  pDeadTimeCfg.RisingSignLock = HRTIM_TIMDEADTIME_RISINGSIGNLOCK_WRITE;
  pDeadTimeCfg.FallingValue = DeathTime_FSBB;
  ...
  pDeadTimeCfg.RisingValue = DeathTime_LCC;
  pDeadTimeCfg.FallingValue = DeathTime_LCC;
  ...
  pCompareCfg.CompareValue = PERIOD_FSBB / 2;
  ...
  pTimeBaseCfg.Period = PERIOD_LCC;
  ...
  pCompareCfg.CompareValue = PERIOD_LCC/2;
